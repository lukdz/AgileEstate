...
class BiddingModel(models.Model):
    property_key = models.ForeignKey('estate.PropertyModel', models.CASCADE)
    owner_key = models.ForeignKey('users.CumstomUser', models.CASCADE)
    winner_key = models.ForeignKey('users.CumstomUser', models.CASCADE)
